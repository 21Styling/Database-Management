...
<body>
    ...
    ?>
        <h1>
            ...
            <i class="fas fa-star favorite-star <?php echo (isset($_SESSION['username']) && in_array($recipe['RecipeId'], $userFavorites)) ? 'favorited' : ''; ?>"
        ...
        <div class="recipe-meta">
            <p>
                ...
                <strong>Author:</strong> <?php echo htmlspecialchars($recipe['Author'] ?? 'N/A'); ?>
            </p>
